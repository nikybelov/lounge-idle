...
export const LOUNGE_TIERS: LoungeTierDef[] = [
  {
    id: 'nook',
    name: 'Первая тяга',
    blurb: 'Камерный старт: один стол, свой ритм. Инструменты смены — сам.',
    cost: 10_500,
    incomeMult: 1,
    clickMult: 1,
    startOwned: { table: 1 },
  ...
  },
  {
    id: 'hall',
    name: 'Сладкий пар',
    blurb: 'Тёплый зал: диван на старте + шуруповёрт. Остальное — с подработки.',
    cost: 17_500,
    incomeMult: 1.2,
    clickMult: 1.15,
  ...
  },
  {
    id: 'signature',
    name: 'Дымный мир',
    blurb: 'Премиум: диваны и стеллаж + шуруповёрт и щипцы. Вытяжку докупаешь сам.',
    cost: 23_000,
    incomeMult: 1.2,
    clickMult: 1.18,
    startOwned: { table: 2, sofa: 2, menu: 1 },
