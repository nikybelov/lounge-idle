...
> = {
  shop: {
    icon: '🛒',
    title: 'Магазин',
    body: 'Инструменты ускоряют мойку, угли и заказ (до 4 уровней) — и на чужой смене, и когда сам вышел в своём зале. Здесь же табачный магазин: купи вкус → выставь во вкладке «Табак». Шуруповёрт необязателен: 35 моек без него — трофей «Голыми руками».',
    cta: 'Понятно',
  },
  tobacco: {
    icon: '📦',
